            ...
            <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="table-wrap">
                    ...
                    <button type="button" class="btn btn-white  btn-lg justify-content-end" name="userprofile"><a class="text-decoration-none" href="index.php">Log Out</a></button>
                    <button type="button" class="btn btn-white  btn-lg justify-content-end" ><a class="text-decoration-none" href="profileuser.php">My Profile</a></button>
